...
SearchResult SimpleTimedSearcher::search_timed(ChessBoard &board, const std::shared_ptr<Stopper> &forced_stopper, const std::shared_ptr<Stopper>& weak_stopper)
{
...
SearchResult SimpleTimedSearcher::search_untimed(ChessBoard &board, const std::shared_ptr<Stopper> &forced_stopper)
{
