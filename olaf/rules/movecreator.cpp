...
// static
bool MoveCreator::valid_move(const ChessBoard& board,
...
// static
bool MoveCreator::pseudo_valid_move(const ChessBoard& board,
                                    const Position& source,
                                    const Position& destination)
{
...
// static
Move MoveCreator::create_move(const ChessBoard& board,
                              const Position& source,
                              const Position& destination)
{
...
// static
bool MoveCreator::is_killable(const ChessBoard& board)
{
